...
import {
  ...
  PersonalInformationSchema,
} from "@/schemes/settings-schemes/personalInformationSchema";
import {
  changeEmailFields,
  changeEmailSchema,
  ChangeEmailSchema,
} from "@/schemes/settings-schemes/changeEmailSchema";
import {
  changePasswordFields,
  changePasswordSchema,
  ChangePasswordSchema,
} from "@/schemes/settings-schemes/changePasswordSchema";
import {
  deleteAccountSchema,
  DeleteAccountSchema,
} from "@/schemes/settings-schemes/deleteAccountSchema";
import { motion } from "framer-motion";
import { DotLottieReact } from "@lottiefiles/dotlottie-react";
import SuccessIcon from "@/shared/assets/animations/success.json";
import { transition } from "@/utils/motions";
import { submitChangePersonalInformationForm } from "@/api/settings-requests/submitChangePersonalInformationForm";
import { submitChangeEmailForm } from "@/api/settings-requests/submitChangeEmailForm";
import { submitChangePasswordForm } from "@/api/settings-requests/submitChangePasswordForm";
import { submitDeleteAccountForm } from "@/api/settings-requests/submitDeleteAccountForm";
